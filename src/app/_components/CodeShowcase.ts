// ============================================================================
// CodeShowcase — section (ported from the original landing HTML)
// ============================================================================
...
<section class="section code-section" id="code">
    <div class="container">
      <div class="section-header animate-on-scroll">
        ...
        <h2 class="section-title">Write less, do more.</h2>
      ...
      <div class="tab-panel active" id="tab-reactivity">
        <div class="code-layout">
          <div class="code-text animate-on-scroll">
            <h3>Signals that just work.</h3>
            <p>
              Create reactive values with <code
                style="color:var(--accent-light);background:var(--accent-subtle);padding:2px 8px;border-radius:4px;">signal()</code>,
              derive with <code
                style="color:var(--accent-light);background:var(--accent-subtle);padding:2px 8px;border-radius:4px;">computed()</code>,
              and watch with <code
                style="color:var(--accent-light);background:var(--accent-subtle);padding:2px 8px;border-radius:4px;">effect()</code>.
      ...
      <div class="tab-panel" id="tab-component">
        <div class="code-layout">
          ...
          <div class="code-block animate-on-scroll">
            <div class="code-header">
              <div class="code-dots"><span></span><span></span><span></span></div>
              <span class="code-filename">components.ts</span>
            </div>
            <div class="code-body">
...
<span class="kw">class</span> <span class="fn">Clock</span> <span class="kw">extends</span> <span class="type">NixComponent</span> {
  ...
  <span class="fn">render</span>() {
    <span class="kw">return</span> <span class="fn">html</span><span class="str">\`&lt;<span class="tag">span</span>&gt;\${() => <span class="kw">this</span>.time.value}&lt;/<span class="tag">span</span>&gt;\`</span>;
      ...
      <!-- Router Tab -->
      <div class="tab-panel" id="tab-router">
        <div class="code-layout">
          <div class="code-text animate-on-scroll">
          ...
          <div class="code-block animate-on-scroll">
            <div class="code-header">
              <div class="code-dots"><span></span><span></span><span></span></div>
              <span class="code-filename">router.ts</span>
            </div>
            <div class="code-body">
...
<span class="kw">const</span> router = <span class="fn">createRouter</span>([
  ...
  { path: <span class="str">"/about"</span>, component: () => <span class="fn">AboutPage</span>() },
  {
    ...
    children: [
      { path: <span class="str">"/stats"</span>,    component: <span class="fn">lazy</span>(
